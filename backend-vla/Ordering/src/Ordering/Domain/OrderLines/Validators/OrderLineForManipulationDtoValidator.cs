...
public class OrderLineForManipulationDtoValidator<T> : AbstractValidator<T> where T : OrderLineForManipulationDto
{
    public OrderLineForManipulationDtoValidator()
    {
