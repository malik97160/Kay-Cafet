...
public static class DockerDatabaseUtilities
{
    ...
    private const string DB_NAME = "Ordering";
    private const string DB_IMAGE = "postgres";
    private const string DB_IMAGE_TAG = "latest";
    private const string DB_CONTAINER_NAME = "IntegrationTesting_Ordering";
    private const string DB_VOLUME_NAME = "IntegrationTesting_Ordering";
