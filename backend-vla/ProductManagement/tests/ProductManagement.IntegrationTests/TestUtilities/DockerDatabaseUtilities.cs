namespace ProductManagement.IntegrationTests.TestUtilities;
...
public static class DockerDatabaseUtilities
{
    ...
    private const string DB_NAME = "ProductManagement";
    private const string DB_IMAGE = "postgres";
    private const string DB_IMAGE_TAG = "latest";
    private const string DB_CONTAINER_NAME = "IntegrationTesting_ProductManagement";
    private const string DB_VOLUME_NAME = "IntegrationTesting_ProductManagement";
